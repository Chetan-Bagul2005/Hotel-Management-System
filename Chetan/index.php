...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<div class="mySlides fade">
		  <img id="1" src="Images/11.jpg" style="width:100%;height: 700px;">
		  <div class="text">ENJOY THE DREAM EXPERIENCE</div>
		</div>

		<div class="mySlides fade">
		  <img id="2" src="Images/12.jpg" style="width:100%;height: 700px;">
		  <div class="text">REDEfINE LUXURY</div>
		</div>

		<div class="mySlides fade">
		  <img id="3" src="Images/3.jpg" style="width:100%;height: 700px;">
